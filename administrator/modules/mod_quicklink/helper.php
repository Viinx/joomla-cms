 ...
 * @subpackage  mod_quicklink
 *
 * @copyright   Copyright (C) 2005 - 2020 Open Source Matters, Inc. All rights reserved.
 * @copyright   Copyright (C) 2005 - 2020 Shayne Bartlett. All rights reserved.
...
/**
 * Helper for mod_quicklink
 *
 * @since  1.6
 */
abstract class ModQuickLinkHelper
{
	/**
	...
	public static function &getButtons($params)
	{
		...
		if (!isset(self::$buttons[$key])) {
			...
			$context = $params->get('context', 'mod_quicklink');

			if ($context == 'mod_quicklink') {
				// Load mod_quicklink language file in case this method is called before rendering the module
				JFactory::getLanguage()->load('mod_quicklink');
				...
				self::$buttons[$key] = array(
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_ADD_NEW_ARTICLE'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_ARTICLE_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_CATEGORY_MANAGER'),
						'access' => array('core.manage', 'com_content'),
						'group'  => 'MOD_QUICKLINK',
					),
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_MEDIA_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_MENU_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_USER_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_MODULE_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_GLOBAL_CONFIGURATION'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_TEMPLATE_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_LANGUAGE_MANAGER'),
					...
					array(
						...
						'text'   => JText::_('MOD_QUICKLINK_INSTALL_EXTENSIONS'),
	...
	{
		$key = $params->get('context', 'mod_quicklink') . '_title';
